...
"""Inference-only Qwen3 model with monitoring hooks.
Copy of qwen3.py with HookPoints added inline."""
...
class Qwen3PForCausalLM(nn.Module, SupportsLoRA, SupportsPP, SupportsEagle3):
