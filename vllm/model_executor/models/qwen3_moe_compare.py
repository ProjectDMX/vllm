...
"""Qwen3-MoE DMI model with same-graph transport reference buffers."""
...
from .qwen3_moe_p import Qwen3MoePForCausalLM
from .utils import PPMissingLayer


class Qwen3MoeCompareForCausalLM(Qwen3MoePForCausalLM):
    """Test-only Qwen3-MoE model retaining independent D2D copies."""
...
__all__ = ["Qwen3MoeCompareForCausalLM"]
